...
- **文档：changed-and-verified**。`README.md` 已同步 v1.8.0 下载入口、抽屉导航与「设置/关于」检查更新入口；功能定义与代码一致。
...
- **工作区：changed-and-verified**。当前仅有单一 `main` worktree；已按用户确认删除历史 `SleepCycle-v1.4.0.apk`、`v1.5.0.apk`、`v1.6.0.apk`、`v1.7.0.apk` 本地副本，保留现役 `SleepCycle-v1.8.0.apk`。
